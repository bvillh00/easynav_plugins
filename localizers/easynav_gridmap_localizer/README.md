# easynav_gridmap_localizer

[![ROS 2: kilted](https://img.shields.io/badge/ROS%202-kilted-blue)](#)

## Description
Easy Navigation: Grid Map localizer package

## Authors and Maintainers
- **Authors:** Bárbara Villalba 
- **Maintainers:** Bárbara Villalba Herreros <bvillh00@estudiantes.unileon.es>
...
- **Type:** `easynav::gridmap::AMCLLocalizer`
- **Base Class:** `easynav::LocalizerMethodBase`
- **Library:** `easynav_gridmap_localizer`
- **Description:** A default "gridmap" implementation for the AMCL localizer.

## Parameters
All parameters are declared under the plugin name namespace, i.e., `/<node_fqn>/easynav_gridmap_localizer/AMCLLocalizer/...`.
...
| `map.gridmap` | `grid_map::GridMap` | **Read** | Grid map with layers (e.g., `elevation`, `traversability`). |
